 ...
 *
 */
public class JavaMethod extends SootMethodAndClass {
	...
	public JavaMethod(String methodName, String returnType, String className) {
		super(methodName, className, returnType, new ArrayList<String>());
		this.permissions = null;
	}

	public JavaMethod(String methodName, List<String> parameters, String returnType, String className) {
	...
	public JavaMethod(SootMethod sm) {
		super(sm);
		this.permissions = null;
	}

	public JavaMethod(SootMethodAndClass methodAndClass) {
		super(methodAndClass);
		this.permissions = null;
	}

	public Set<String> getPermissions() {
		return this.permissions == null ? Collections.emptySet()
				: this.permissions;
	}
	 ...
	 */
	public static JavaMethod createFromSignature(String signature) {
		...
		return new JavaMethod(smac.getMethodName(), smac.getParameters(),
